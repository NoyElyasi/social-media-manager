import { getWeekStart, formatCalendarDate, getWeekPlan, generateWeeklySchedule } from "@/lib/weeklySchedule";
 ...
 * נכון בין השבועות ולא ישובץ פעמיים לאותו תוכן בשני שבועות שונים.
 */
